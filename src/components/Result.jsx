	...
	return (
		<>
				...
				<>
					<div className="flex flex-col text-center items-center pt-[128px]">
						...
						<p className="secondGsap opacity-0 text-[33px] max-w-[700px] mb-[30px]">
							Thank you for taking our quiz – for taking time to get more
							informed about modern slavery and human trafficking. Find out how
							you can get involved in the anti-trafficking movement by scanning
							the QR code.
						</p>
						<Button
			...
			{branding === "sfa" && (
				<>
					<div className="flex flex-col text-center items-center pt-[128px]">
						<h2 className="secondGsap opacity-0 text-[80px] font-fk flex items-center gap-10">
							You scored
						</h2>
						<p className="secondGsap font-sfabody font-bold text-[194px]">
							{score}/{quizData.length}
						</p>
						{/* svg */}
						<p className="secondGsap opacity-0 font-sfabody text-[38px] max-w-[700px] mb-[60px]">
							Thank you for taking our quiz – for taking time to get more
							informed about modern slavery and human trafficking.
						</p>
						<Button
							className="secondGsap bg-sfa-orange font-sfabody font-bold opacity-0"
							text="Reset Quiz"
							onClick={() => window.location.reload()}
						/>
					</div>
